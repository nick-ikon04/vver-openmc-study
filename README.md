...
## Звіт і приклади результатів

- [П'ятисторінковий технічний звіт українською](docs/zvit_openmc_tvel_tvz_7tvz_20260823_uk.docx)
  містить підсумки для паливної комірки, ТВЗ-331, кластера із семи ТВЗ та
  п'яти температурно-борних станів.
- [Перевірені приклади результатів](examples/README.md) містять компактні CSV,
  JSON і PNG без важких HDF5, згенерованих XML та журналів OpenMC.
...
`.gitignore` виключає повні результати OpenMC, HDF5, згенеровані XML, більшість
звітів, архіви, кеші, віртуальні середовища та локальні налаштування. У Git
зберігаються лише вибрані компактні приклади та один опублікований технічний
звіт. Великі вихідні дані слід зберігати окремо, наприклад у Google Drive.
